...
public class PermissionController {
	...
	@PostMapping("/")
	public ResponseEntity<?> savePermission(@RequestBody @Valid PermissionDTO info, BindingResult validations)
			throws Exception {
		...
		try {
			...
			return new ResponseEntity<>(new MessageDTO("Permission created!"), HttpStatus.OK);
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<?> deletePermissionById(@PathVariable UUID id) throws Exception {
		...
		try {
			...
			return new ResponseEntity<>(new MessageDTO("Permission deleted!"), HttpStatus.OK);
